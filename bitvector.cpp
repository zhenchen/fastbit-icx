...
((1U << ibis::bitvector::SECONDBIT - 4) - 1);
const ibis::bitvector::word_t ibis::bitvector::MAXCNT_ICX = 
((1U << (ibis::bitvector::SECONDBIT-3) -1 ));
...
const ibis::bitvector::word_t ibis::bitvector::HEADER0_ICX =
(4U << (ibis::bitvector::MAXBITS - 2));
const ibis::bitvector::word_t ibis::bitvector::HEADER1_ICX =
(7U << (ibis::bitvector::MAXBITS - 2));
const ibis::bitvector::word_t ibis::bitvector::HEADER_0F_ICX =
(32U << ibis::bitvector::SECONDBIT - 4);
const ibis::bitvector::word_t ibis::bitvector::HEADER_1F_ICX =
(33U << ibis::bitvector::SECONDBIT - 4);
const ibis::bitvector::word_t ibis::bitvector::HEADER_0L_F_0L_ICX = 
(10U << (ibis::bitvector::MAXBITS - 3));
const ibis::bitvector::word_t ibis::bitvector::HEADER_1L_F_0L_ICX = 
(13U << (ibis::bitvector::MAXBITS - 3));
const ibis::bitvector::word_t ibis::bitvector::HEADER_0L_F_1L_ICX = 
(12U << (ibis::bitvector::MAXBITS - 3));
const ibis::bitvector::word_t ibis::bitvector::HEADER_1L_F_1L_ICX = 
(11U << (ibis::bitvector::MAXBITS - 3));
const ibis::bitvector::word_t ibis::bitvector::HEADER_FLF_ICX = 
...
(255U<<24);
const ibis::bitvector::word_t ibis::bitvector::ICX_0_DIRTYMASK3 =  
(255U<<16);
const ibis::bitvector::word_t ibis::bitvector::ICX_0_DIRTYMASK2 =  
(255U<<8);
const ibis::bitvector::word_t ibis::bitvector::ICX_0_DIRTYMASK1 =
(255u);
const ibis::bitvector::word_t ibis::bitvector::ICX_1_DIRTYMASK4 = 
(127U<<24);
const ibis::bitvector::word_t ibis::bitvector::ICX_1_DIRTYMASK3 =  
~(255U<<16);
const ibis::bitvector::word_t ibis::bitvector::ICX_1_DIRTYMASK2 =  
~(255U<<8);
const ibis::bitvector::word_t ibis::bitvector::ICX_1_DIRTYMASK1 =
~(255u);
...
//compress_icx function
void ibis::bitvector::compress_icx() {
	...
	void decode() {
		...
		{
			isDirty0 =( (int)(bool)(*it & ICX_0_DIRTYMASK1)+(int)(bool)(*it & ICX_0_DIRTYMASK2)+(int)(bool)(*it & ICX_0_DIRTYMASK3)+(int)(bool)(*it & ICX_1_DIRTYMASK4) == 1 );
			//isDirty1 =( (int)(bool)(*it & ICX_1_DIRTYMASK1)+(int)(bool)(*it & ICX_1_DIRTYMASK2)+(int)(bool)(*it & ICX_1_DIRTYMASK3)+(int)(bool)(*it & ICX_1_DIRTYMASK4) == 1 );
			isDirty1 =( (int)(bool)(~(*it) & ICX_0_DIRTYMASK1)+(int)(bool)(~(*it) & ICX_0_DIRTYMASK2)+(int)(bool)(~(*it) & ICX_0_DIRTYMASK3)+(int)(bool)(~(*it) & ICX_1_DIRTYMASK4) == 1 );
			dirtyPos0 = ((int)(bool)(*it & ICX_1_DIRTYMASK4) << 3 )+ ((int)(bool)(*it & ICX_0_DIRTYMASK3) << 2) + ((int)(bool)(*it & ICX_0_DIRTYMASK2) << 1 ) + ((int)(bool)(*it & ICX_0_DIRTYMASK1));   // More efficient
...
/*	    if ((current.fillBit == 0 && *(last.it) == 0) ||
	    ...
	    // the same
	    if (*(current.it) == 0) { // make a 2-word 0-fill
			*(last.it) = HEADER_0F_ICX | 2;
	    }
	    else if (*(current.it) == ALLONES) { // make a 2-word 1-fill
		*(last.it) = HEADER_1F_ICX | 2;
	    }
	    else { // move last forward
			*(beforeLast.it) = *(last.it);
			last.it++;
	...
	/*				if((last.fillBit == 0 || *(current.it)==0)&&(last.fillBit!=0 || *(current.it)== ALLONES)){ // FFL, L=2nd F
				...
				/*	if((current.fillBit == 0 || *(last.it)==0)&&(current.fillBit!=0 || *(last.it)== ALLONES)){		//L & F are the same
						*(last.it) = current.nWords + 1;
						...
						if((last.isDirty0^last.isDirty1) != 1){ //L not dirty
						beforeLast.it++;
						*(beforeLast.it) = *(last.it);
						last.it++;
						*(last.it) = *(current.it);
							...
							/*if(beforeLast.fillBit != current.fillBit){ // not the same fill. should be modified in ICX and ICX
																	   // There is modified
								...
								*(beforeLast.it) = beforeLast.nWords << 16;
								...
								else
								{
									*(beforeLast.it) += (1U<<27);
									...
									case 8: *(beforeLast.it) += ((*(last.it) & ICX_1_DIRTYMASK4) >>16); *(beforeLast.it) += (3U << 24);  break;
									case 4: *(beforeLast.it) += ((*(last.it) & ICX_0_DIRTYMASK3)>>8); *(beforeLast.it) += (2U << 24); break;
									case 2: *(beforeLast.it) += (*(last.it) & ICX_0_DIRTYMASK2); *(beforeLast.it) += (1U << 24); break;
									case 1: *(beforeLast.it) += ((*(last.it) & ICX_0_DIRTYMASK1)<<8); break;
								}
								}
								if (current.fillBit) 
								{
			...
			if(!last.isFill){//LL
				...
				//fisrt L dirty	
					//LFL fisrt F dirty
						...
						{//LFL encoding!
							...
							else
							{
								...
								else
								{
									...
									case 8: *(beforeLast.it) = ((*(beforeLast.it) & ICX_1_DIRTYMASK4)>> 16); *(beforeLast.it) += (3U << 26); break;
									case 4: *(beforeLast.it) = ((*(beforeLast.it) & ICX_0_DIRTYMASK3)>> 8); *(beforeLast.it) += (2U << 26); break;
									case 2: *(beforeLast.it) = (*(beforeLast.it) & ICX_0_DIRTYMASK2); *(beforeLast.it) += (1U << 26); break;
								...
								else
								{
									...
									case 8: *(beforeLast.it) += ((*(current.it) & ICX_1_DIRTYMASK4)>> 24) ; *(beforeLast.it) += (3U << 24); break;
									case 4: *(beforeLast.it) += ((*(current.it) & ICX_0_DIRTYMASK3)>>16); *(beforeLast.it) += (2U << 24); break;
									case 2: *(beforeLast.it) += ((*(current.it) & ICX_0_DIRTYMASK2)>> 8); *(beforeLast.it) += (1U << 24); break;
									case 1: *(beforeLast.it) += (*(current.it) & ICX_0_DIRTYMASK1); break;
									}
								}
							*(beforeLast.it) += (last.nWords << 16);
							*(beforeLast.it) += (last.fillBit << 23);
							if(beforeLast.isDirty0 && current.isDirty0)
							  *(beforeLast.it) += HEADER_0L_F_0L_ICX;
							if(beforeLast.isDirty1 && current.isDirty0)
							  *(beforeLast.it) += HEADER_1L_F_0L_ICX;
							if(beforeLast.isDirty0 && current.isDirty1)
							  *(beforeLast.it) += HEADER_0L_F_1L_ICX;
							if(beforeLast.isDirty1 && current.isDirty1)
							  *(beforeLast.it) += HEADER_1L_F_1L_ICX;
							last.it = beforeLast.it;
							last.it++;
							beforeLast.it++;
							existBeforeLast = false;
						...
						{
							if((current.isFill)&&(current.fillBit == last.fillBit))
							{//LFF
								// same kind of fill
									*(last.it) += current.nWords ;
							}
...
void ibis::bitvector::decompress_icx()
{
	struct xrun {
		bool isLiteral;
		int icxType;
		int fillType1; //useful for 0-FILL, 1-FILL, LFL, FLF(1st), 0NL2-F and L-F
		int fillType2; //only useful for FLF(2nd)
		int NILiteralType; //only useful for FLF and L-F
		int dirtyBytePos1, dirtyBytePos2;	//dirtyBytePos1 is useful for FLF, L-F, 0NL2-F(1st) and LFL(1st), while dirtyBytePos2 useful for 0NL2-F(2nd) and LFL(2nd)
		word_t dirtyByte1, dirtyByte2;  //similar with the above
		word_t counter1, counter2;
		array_t<word_t>::iterator it;

		xrun() : isLiteral(false), icxType(0), fillType1(0), fillType2(0), NILiteralType(0), 
...
//	std::cout<<"m_vec.size"<<m_vec.size()<<std::endl;
	...
	for (++current.it; current.it <m_vec.end(); ++ current.it)
	{
		...
		else
		{
			...
			else if(current.icxType == 1) //0NL2-F
			{
				switch (current.dirtyBytePos1)
				{
					case 0: *currentTmp.it = current.dirtyByte1;break;
			...
			else if(current.icxType == 2) //0L1-F-0L2
			{
				switch (current.dirtyBytePos1)
				{
				case 0: *currentTmp.it = current.dirtyByte1;break;
			...
			else if(current.icxType == 3) //1L1-F-1L2
			{
				switch (current.dirtyBytePos1)
				{
				case 0: *currentTmp.it = 0x7fffff00 | current.dirtyByte1;break;
			...
			else if(current.icxType == 4) //0L1-F-1L2
			{
				switch (current.dirtyBytePos1)
				{
				case 0: *currentTmp.it = current.dirtyByte1;break;
			...
			else if(current.icxType == 5) //1L1-F-0L2
			{
				switch (current.dirtyBytePos1)
				{
				case 0: *currentTmp.it = 0x7fffff00 | current.dirtyByte1;break;
